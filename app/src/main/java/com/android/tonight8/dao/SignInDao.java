...
public class SignInDao extends AbstractDao<SignIn, Long> {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SIGN_IN' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SIGN_IN'";
        db.execSQL(sql);
    }
    ...
    /** @inheritdoc */
    @Override
    public SignIn readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(SignIn entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
