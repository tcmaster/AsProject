...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DaoConfig awardHitDaoConfig;
    private final DaoConfig voteItemOptionDaoConfig;
    private final DaoConfig voteResultDaoConfig;
    private final DaoConfig flyScreenDaoConfig;
    ...
    private final AwardHitDao awardHitDao;
    private final VoteItemOptionDao voteItemOptionDao;
    private final VoteResultDao voteResultDao;
    private final FlyScreenDao flyScreenDao;
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        awardHitDaoConfig = daoConfigMap.get(AwardHitDao.class).clone();
        awardHitDaoConfig.initIdentityScope(type);

        voteItemOptionDaoConfig = daoConfigMap.get(VoteItemOptionDao.class).clone();
        voteItemOptionDaoConfig.initIdentityScope(type);

        voteResultDaoConfig = daoConfigMap.get(VoteResultDao.class).clone();
        voteResultDaoConfig.initIdentityScope(type);

        flyScreenDaoConfig = daoConfigMap.get(FlyScreenDao.class).clone();
        flyScreenDaoConfig.initIdentityScope(type);

        praiseDaoConfig = daoConfigMap.get(PraiseDao.class).clone();
        praiseDaoConfig.initIdentityScope(type);
        ...
        awardHitDao = new AwardHitDao(awardHitDaoConfig, this);
        voteItemOptionDao = new VoteItemOptionDao(voteItemOptionDaoConfig, this);
        voteResultDao = new VoteResultDao(voteResultDaoConfig, this);
        flyScreenDao = new FlyScreenDao(flyScreenDaoConfig, this);
        praiseDao = new PraiseDao(praiseDaoConfig, this);
        ...
        registerDao(AwardHit.class, awardHitDao);
        registerDao(VoteItemOption.class, voteItemOptionDao);
        registerDao(VoteResult.class, voteResultDao);
        registerDao(FlyScreen.class, flyScreenDao);
        registerDao(Praise.class, praiseDao);
    }
    ...
    public void clear() {
        ...
        awardHitDaoConfig.getIdentityScope().clear();
        voteItemOptionDaoConfig.getIdentityScope().clear();
        voteResultDaoConfig.getIdentityScope().clear();
        flyScreenDaoConfig.getIdentityScope().clear();
        praiseDaoConfig.getIdentityScope().clear();
    }
    ...
    public AwardHitDao getAwardHitDao() {
        return awardHitDao;
    }

    public VoteItemOptionDao getVoteItemOptionDao() {
        return voteItemOptionDao;
    }
    ...
    public FlyScreenDao getFlyScreenDao() {
        return flyScreenDao;
    }
