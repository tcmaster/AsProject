...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AwardHitDao.class);
        registerDaoClass(VoteItemOptionDao.class);
        registerDaoClass(VoteResultDao.class);
        registerDaoClass(FlyScreenDao.class);
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        AwardHitDao.createTable(db, ifNotExists);
        VoteItemOptionDao.createTable(db, ifNotExists);
        VoteResultDao.createTable(db, ifNotExists);
        FlyScreenDao.createTable(db, ifNotExists);
        PraiseDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ...
        AwardHitDao.dropTable(db, ifExists);
        VoteItemOptionDao.dropTable(db, ifExists);
        VoteResultDao.dropTable(db, ifExists);
        FlyScreenDao.dropTable(db, ifExists);
        PraiseDao.dropTable(db, ifExists);
    }
