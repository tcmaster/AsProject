...
/** 
 * DAO for table DETAIL_PIC.
*/
public class DetailPicDao extends AbstractDao<DetailPic, Long> {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'DETAIL_PIC'";
        db.execSQL(sql);
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DetailPic entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
