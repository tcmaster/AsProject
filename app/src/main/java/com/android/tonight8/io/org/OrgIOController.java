...
//		HandlerConstants.sendMessage(handler, null, 0,
//				HandlerConstants.NETWORK_BEGIN, 0);
//		NetRequest.doPostRequest(params, new RequestResult<Org>(Org.class,
//				handler) {
//
//			@Override
//			public void getData(NetEntityBase netEntityBase, Org t,
//					Handler handler) {
//
...
//		});
	...
	public static void OrgMessageListRead(final Handler handler,
			final String orgId, final int... attachments) {
//		Map<String, String> params = new HashMap<String, String>();
...
//		NetRequest.doGetRequest(params, new RequestResult<OrgMessageNetEntity>(
//				OrgMessageNetEntity.class, handler) {
//
//			@Override
//			public void getData(NetEntityBase netEntityBase,
//					OrgMessageNetEntity t, Handler handler) {
//
//				if (netEntityBase != null
//						&& NetUtils.checkResult(netEntityBase)) {
//					Utils.toast(netEntityBase.message);
//					// OrgStorage.getOrgMessageController().saveOrUpdateData(t.getOrgMessageModels());
//					// List<OrgMessageModel> list =
//					// OrgStorage.getOrgMessageController().selectData(orgId,
...
//					}
//					HandlerConstants.sendMessage(handler, list, 0,
...
//		});
	...
	public static void OrgQuestionsRead(final Handler handler, final int orgId,
...
//		HandlerConstants.sendMessage(handler, null, 0,
//				HandlerConstants.NETWORK_BEGIN, attachments[0]);
//		NetRequest.doPostRequest(params,
//				new RequestResult<UserQuestionBackNetEntity>(
//						UserQuestionBackNetEntity.class, handler) {
//
//					@Override
//					public void getData(NetEntityBase netEntityBase,
//							UserQuestionBackNetEntity t, Handler handler) {
//						List<OrgQuestionModel> list = null;
//						if (NetUtils.checkResult(netEntityBase)) {
//							list = t.getOrgManageQuestions();
//							// OrgStorage.getOrgQuestionController().saveOrUpdateData(list,
//							// orgId);
//						}
//						// list =
//						// OrgStorage.getOrgQuestionController().selectData(orgId,
...
//				});
	...
	public static void OrgOrgQuestionsReply(final Handler handler,
			String questionId, String content, final String orgId,
			final int... attachments) {
//		Map<String, String> params = new HashMap<String, String>();
...
//		HandlerConstants.sendMessage(handler, null, 0,
//				HandlerConstants.NETWORK_BEGIN, attachments[0]);
//		NetRequest.doPostRequest(params, new RequestResult<UserQuestionModel>(
//				UserQuestionModel.class, handler) {
//
//			@Override
//			public void getData(NetEntityBase netEntityBase,
//					UserQuestionModel t, Handler handler) {
//
//				if (NetUtils.checkResult(netEntityBase)) {
//					Utils.toast(netEntityBase.message);
//					HandlerConstants.sendMessage(handler, null, 0,
