...
public class EventIOControllerTest {
	...
	// private static final String EVENT_EVENT_PUBLISH_CONSULTS =
	// NetRequest.BASE_URL
	// + "";
	...
	// };
	//
	// public static void eventListRead(final Handler handler, int...
	// attachments) {
	...
	// }
	// EventListNativeControllerTest eventListNativeControllerTest = new
	// EventListNativeControllerTest();
