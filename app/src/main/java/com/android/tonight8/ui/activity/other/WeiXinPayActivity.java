package com.android.tonight8.ui.activity.other;//package com.android.tonight8.activity.other;
//
//import java.io.*;
//import java.util.*;
//
...
//import com.android.tonight8.utils.WXPayUtils;
...
//
//		// 生成签名参数
//		Button appay_pre_btn = (Button) findViewById(R.id.);
...
//		});
//
//		String packageSign = MD5Utils.getMessageDigest(sb.toString().getBytes())
//				.toUpperCase();
//
//	}
//
...
//			Log.e("orion", entity);
//
//			byte[] buf = WXPayUtils.httpPost(url, entity);
//
