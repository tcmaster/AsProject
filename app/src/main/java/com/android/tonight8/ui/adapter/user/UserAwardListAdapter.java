...
import com.android.tonight8.ui.activity.user.UserAwardSignActivity;
 ...
 * @Date:2015-1-27
 */
public class UserAwardListAdapter extends BaseListAdapter<String> {

	public UserAwardListAdapter(Context context, List<String> models) {
