...
public class UserInfoActivity extends BaseActivity {
	...
	private void initDatas() {
		...
		setTextAndContent(layout_nickname, R.string.nick_name,
				R.mipmap.vnickname);
		setTextAndContent(layout_sex, R.string.sex, R.mipmap.vsex);
		setTextAndContent(layout_phone, R.string.phone_num, R.mipmap.vphone);
		setTextAndContent(layout_email, R.string.email_name, R.mipmap.vemail);
