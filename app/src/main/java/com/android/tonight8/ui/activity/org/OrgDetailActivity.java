...
public class OrgDetailActivity extends BaseActivity {
	...
	private void initData() {
		...
		getBitmapUtils().display(iv_org_logo, org.getLogo());
		tv_shop_name_value.setText(org.getName());
		tv_shop_id_value.setText(org.getId() + "");
		QRCodeUtils.createQRImage(org.getId() + "", iv_org_dimension);
		tv_personname_value.setText(org.getMember()+"");
		tv_phone_value.setText(org.getContactMobilePhone());
		tv_email_value.setText(org.getEmail());
		tv_tele_value.setText(org.getTelephone());
		// tv_org_website.setText();
		tv_org_description.setText(org.getIntroduce());
	}
}
