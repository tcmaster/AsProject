...
public class PostEventsGridAdapter extends BaseAdapter {
	...
	private String[] strMenu = { "发布活动", "活动中奖管理", "促销券使用", " 绑定经销商", "已用券核销",
			"兑奖地点管理", " 用户反馈", "退出后台", "" };
	private int[] intMenu = { R.mipmap.pencil_red_big,
			R.mipmap.star_red_big, R.mipmap.avg_red, R.mipmap.chain_big,
			R.mipmap.avg_red_ok, R.mipmap.talk_red_big,
			R.mipmap.talk_red_big, R.mipmap.talk_red_big,
			R.mipmap.talk_red_big };
